 ...
 *    '<S6>/Deadband pulse counter'
 *    '<S11>/Deadband pulse counter'
...
uint32_T MWDSP_EPH_R_B(boolean_T evt, uint32_T *sta)
{
  ...
  /* S-Function (sdspcount2): '<S5>/X Matrix Counter' */
  ...
  /* End of S-Function (sdspcount2): '<S5>/X Matrix Counter' */
  return retVal;
}
...
void Pos_PID_output(void)
{
  ...
  if (rtmIsMajorTimeStep(Pos_PID_M)) {
    /* Level2 S-Function Block: '<S8>/CNT32-8M(PCI) 2' (encconteccnt328mpci) */
    {
  ...
  Pos_PID_B.FilterCoefficient = Pos_PID_P.XController_N * Pos_PID_B.SumD;
  ...
  /* MATLAB Function: '<S6>/Deadband pulse counter' incorporates:
  ...
  if (rtmIsMajorTimeStep(Pos_PID_M)) {
    /* Level2 S-Function Block: '<S13>/CNT32-8M(PCI) 1' (encconteccnt328mpci) */
    {
  ...
  if (rtmIsMajorTimeStep(Pos_PID_M)) {
    ...
    /* S-Function (sdspcount2): '<S10>/Y Matrix Counter' */
    ...
    /* End of S-Function (sdspcount2): '<S10>/Y Matrix Counter' */

    /* Lookup_n-D: '<S10>/Y Matrix output' */
  ...
  Pos_PID_B.FilterCoefficient_p = Pos_PID_P.YController_N * Pos_PID_B.SumD_b;
  ...
  /* MATLAB Function: '<S11>/Deadband pulse counter' incorporates:
  ...
  if (rtmIsMajorTimeStep(Pos_PID_M)) {
     ...
     */
    Pos_PID_B.DataTypeConversion1 = Pos_PID_P.Constant_Value;

    /* DataTypeConversion: '<S2>/Data Type Conversion2' */
    Pos_PID_B.DataTypeConversion2_i = (Pos_PID_B.DataTypeConversion1 != 0.0);
    ...
    /* ToAsyncQueueBlock: '<S8>/HiddenToAsyncQueue_InsertedFor_count_to_mm1_at_outport_0' */
    if (rtmIsMajorTimeStep(Pos_PID_M)) {
      {
        double time = Pos_PID_M->Timing.t[1];
        void *pData = (void *)&Pos_PID_B.XData;
        int32_T size = 1*sizeof(real_T);
        sendToAsyncQueueTgtAppSvc(1245264614U, time, pData, size);
      }
    }
    ...
    /* ToAsyncQueueBlock: '<S13>/HiddenToAsyncQueue_InsertedFor_count_to_mm_at_outport_0' */
    if (rtmIsMajorTimeStep(Pos_PID_M)) {
      {
        double time = Pos_PID_M->Timing.t[1];
        void *pData = (void *)&Pos_PID_B.YData;
        int32_T size = 1*sizeof(real_T);
        sendToAsyncQueueTgtAppSvc(3121838153U, time, pData, size);
      }
    }
  }
  ...
  if (rtmIsMajorTimeStep(Pos_PID_M)) {
    ...
    /* Sin: '<Root>/Reference Force' */
    if (Pos_PID_DW.systemEnable != 0) {
      u = Pos_PID_P.f * 2.0 * 3.1415926535897931;
      Pos_PID_DW.lastSin = sin(u * Pos_PID_M->Timing.t[1]);
      u = Pos_PID_P.f * 2.0 * 3.1415926535897931;
      Pos_PID_DW.lastCos = cos(u * Pos_PID_M->Timing.t[1]);
      Pos_PID_DW.systemEnable = 0;
    }

    Pos_PID_B.ReferenceForce = ((Pos_PID_DW.lastSin *
      Pos_PID_P.ReferenceForce_PCos + Pos_PID_DW.lastCos *
      Pos_PID_P.ReferenceForce_PSin) * Pos_PID_P.ReferenceForce_HCos +
      (Pos_PID_DW.lastCos * Pos_PID_P.ReferenceForce_PCos - Pos_PID_DW.lastSin *
       Pos_PID_P.ReferenceForce_PSin) * Pos_PID_P.ReferenceForce_Hsin) *
      Pos_PID_P.amp + Pos_PID_P.bias;

    /* End of Sin: '<Root>/Reference Force' */

    /* Sum: '<Root>/Sum4' */
    Pos_PID_B.Sum4 = Pos_PID_B.ReferenceForce - Pos_PID_B.orceData[2];
  ...
  Pos_PID_B.FilterCoefficient_b = Pos_PID_P.ZController_N * Pos_PID_B.SumD_k;
  ...
  /* Sum: '<Root>/Sum5' */
  Pos_PID_B.Zenable = Pos_PID_B.Sum_a - Pos_PID_B.orceData[2];
    ...
    if (rtmIsMajorTimeStep(Pos_PID_M)) {
      {
        ...
        sendToAsyncQueueTgtAppSvc(2463312567U, time, pData, size);
      }
    }
  ...
  if (rtmIsMajorTimeStep(Pos_PID_M)) {
    /* Level2 S-Function Block: '<S7>/PCI-DDA 08 12 4' (dopci8255) */
    {
  ...
  if (rtmIsMajorTimeStep(Pos_PID_M)) {
    /* Level2 S-Function Block: '<S12>/PCI-DDA 08 12 3' (dopci8255) */
    {
  ...
  Pos_PID_B.LogicalOperator_m = ((Pos_PID_B.Zenable_e != 0.0) &&
    (Pos_PID_B.PCIDDA08123 != 0.0));

  /* DataTypeConversion: '<S17>/Data Type Conversion' */
  Pos_PID_B.DataTypeConversion = Pos_PID_B.LogicalOperator_m;
  if (rtmIsMajorTimeStep(Pos_PID_M)) {
...
void Pos_PID_update(void)
{
  ...
  if (rtmIsMajorTimeStep(Pos_PID_M)) {
    ...
    /* Update for Sin: '<Root>/Reference Force' */
    HoldSine = Pos_PID_DW.lastSin;
    HoldCosine = Pos_PID_DW.lastCos;
    Pos_PID_DW.lastSin = HoldSine * Pos_PID_P.ReferenceForce_HCos + HoldCosine *
      Pos_PID_P.ReferenceForce_Hsin;
    Pos_PID_DW.lastCos = HoldCosine * Pos_PID_P.ReferenceForce_HCos - HoldSine *
      Pos_PID_P.ReferenceForce_Hsin;
...
void Pos_PID_initialize(void)
{
  ...
  /* S-Function Block: <S22>/S-Function (scblock) */
  {
    ...
    if ((i = rl32eScopeExists(2)) == 0) {
      if ((i = rl32eDefScope(2,2)) != 0) {
        ...
        rl32eAddSignal(2, rl32eGetSignalNo("Reference Force"));
        rl32eSetScope(2, 4, 5000);
        rl32eSetScope(2, 5, 0);
        rl32eSetScope(2, 6, 1);
        rl32eSetScope(2, 0, 0);
        rl32eSetScope(2, 3, rl32eGetSignalNo(
          "Force Subsystem/Byte Unpacking 1/s3"));
  ...
  /* S-Function Block: <S23>/S-Function (scblock) */
  {
    ...
    if ((i = rl32eScopeExists(5)) == 0) {
      if ((i = rl32eDefScope(5,3)) != 0) {
        ...
        rl32eAddSignal(5, rl32eGetSignalNo("Reference Force"));
  ...
  /* InitializeConditions for S-Function (sdspcount2): '<S5>/X Matrix Counter' */
  ...
  /* InitializeConditions for S-Function (sdspcount2): '<S10>/Y Matrix Counter' */
  ...
  /* Enable for Sin: '<Root>/Reference Force' */
  Pos_PID_DW.systemEnable = 1;
}
...
RT_MODEL_Pos_PID_T *Pos_PID(void)
{
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: Pos_PID/<S8>/CNT32-8M(PCI) 2 (encconteccnt328mpci) */
    {
      SimStruct *rts = Pos_PID_M->childSfunctions[0];
    ...
    /* Level2 S-Function Block: Pos_PID/<S13>/CNT32-8M(PCI) 1 (encconteccnt328mpci) */
    {
      SimStruct *rts = Pos_PID_M->childSfunctions[1];
    ...
    /* Level2 S-Function Block: Pos_PID/<S7>/PCI-DDA 08 12 4 (dopci8255) */
    {
      SimStruct *rts = Pos_PID_M->childSfunctions[4];
    ...
    /* Level2 S-Function Block: Pos_PID/<S12>/PCI-DDA 08 12 3 (dopci8255) */
    {
      SimStruct *rts = Pos_PID_M->childSfunctions[5];
  ...
  Pos_PID_M->Sizes.numBlocks = (113);  /* Number of blocks */
  Pos_PID_M->Sizes.numBlockIO = (92);  /* Number of block outputs */
  Pos_PID_M->Sizes.numBlockPrms = (579);/* Sum of parameter "widths" */
  return Pos_PID_M;
}
