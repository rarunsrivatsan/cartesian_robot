...
/* Block signals for system '<S8>/Deadband pulse counter' */
typedef struct {
  real_T pulse;                        /* '<S8>/Deadband pulse counter' */
...
typedef struct {
  ...
  real_T XMatrixindex;                 /* '<S7>/X Matrix Counter' */
  real_T XMatrixoutput;                /* '<S7>/X Matrix output' */
  real_T Sum;                          /* '<Root>/Sum' */
  ...
  boolean_T DataStoreRead5;            /* '<S7>/Data Store Read5' */
  boolean_T UnitDelay2;                /* '<S7>/Unit Delay2' */
  boolean_T XMatrixCounter_o2;         /* '<S7>/X Matrix Counter' */
  boolean_T UnitDelay;                 /* '<S8>/Unit Delay' */
  boolean_T Counter_o2;                /* '<S8>/Counter' */
  boolean_T DataTypeConversion1_f;     /* '<S8>/Data Type Conversion1' */
  boolean_T DataTypeConversion1_h;     /* '<S5>/Data Type Conversion1' */
  boolean_T UnitDelay_b;               /* '<S5>/Unit Delay' */
  ...
  boolean_T DataTypeConversion1_p;     /* '<S12>/Data Type Conversion1' */
  boolean_T DataTypeConversion_p;      /* '<S5>/Data Type Conversion' */
  ...
  boolean_T ZMatrixCounter_o2;         /* '<S15>/Z Matrix Counter' */
  boolean_T UnitDelay_bj;              /* '<S16>/Unit Delay' */
  boolean_T Counter_o2_c;              /* '<S16>/Counter' */
  boolean_T DataTypeConversion1_pn;    /* '<S16>/Data Type Conversion1' */
  boolean_T DataTypeConversion2_i;     /* '<S5>/Data Type Conversion2' */
  ...
  B_Deadbandpulsecounter_Pos_PI_T sf_Deadbandpulsecounter;/* '<S8>/Deadband pulse counter' */
} B_Pos_PID_T;
...
typedef struct {
  ...
  uint32_T XMatrixCounter_ClkEphState; /* '<S7>/X Matrix Counter' */
  uint32_T XMatrixCounter_RstEphState; /* '<S7>/X Matrix Counter' */
  uint32_T Counter_ClkEphState;        /* '<S8>/Counter' */
  uint32_T Counter_RstEphState;        /* '<S8>/Counter' */
  ...
  uint32_T ZMatrixCounter_RstEphState; /* '<S15>/Z Matrix Counter' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_i;                 /* '<S33>/S-Function' */
  ...
  boolean_T UnitDelay2_DSTATE;         /* '<S7>/Unit Delay2' */
  ...
  boolean_T UnitDelay_DSTATE_g;        /* '<S15>/Unit Delay' */
  boolean_T UnitDelay_DSTATE_p;        /* '<S16>/Unit Delay' */
  uint8_T XMatrixCounter_Count;        /* '<S7>/X Matrix Counter' */
  uint8_T Counter_Count;               /* '<S8>/Counter' */
...
struct P_Pos_PID_T_ {
  ...
  real_T count_to_mm_Gain_j;           /* Expression: 200/82720
                                        ...
                                        */
  real_T ZMatrixoutput_bp01Data[21];   /* Expression: [0:20]
                                        * Referenced by: '<S15>/Z Matrix output'
                                        */
 ...
 * '<S5>'   : 'Pos_PID/System Moving Flag'
 * '<S6>'   : 'Pos_PID/Variable Scope'
 * '<S7>'   : 'Pos_PID/X Position Input'
 * '<S8>'   : 'Pos_PID/X Position signal'
