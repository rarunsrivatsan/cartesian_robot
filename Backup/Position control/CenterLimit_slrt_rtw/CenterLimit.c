...
static void CenterLimit_output(void)
{
  ...
  CenterLimit_B.Constant1 = CenterLimit_P.Constant1_Value;
...
RT_MODEL_CenterLimit_T *CenterLimit(void)
{
    ...
    /* Level2 S-Function Block: CenterLimit/<Root>/PCI-DDA08 12  (dacbpcidda0x12) */
    {
      ...
      /* inputs */
      {
        ...
        /* port 2 */
        {
          ...
          sfcnUPtrs[0] = &CenterLimit_B.Constant1;
  ...
  CenterLimit_M->Sizes.numBlocks = (9);/* Number of blocks */
  CenterLimit_M->Sizes.numBlockIO = (5);/* Number of block outputs */
  CenterLimit_M->Sizes.numBlockPrms = (205);/* Sum of parameter "widths" */
