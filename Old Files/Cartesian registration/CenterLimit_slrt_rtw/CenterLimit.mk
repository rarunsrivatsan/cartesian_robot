...
MODEL           = CenterLimit
MODULES         = CenterLimit_capi.c CenterLimit_data.c CenterLimit_tgtconn.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = CenterLimit.mk
...
S_FUNCTIONS     = xpcudpbytereceive.c dacbpcidda0x12.c dipci8255.c dopci8255.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = CenterLimitlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = CenterLimit_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\CenterLimit_slrt_rtw
