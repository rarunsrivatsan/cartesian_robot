...
MODEL           = Registration_Estimation
MODULES         = Registration_Estimation_capi.c Registration_Estimation_data.c Registration_Estimation_tgtconn.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = Registration_Estimation.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\BIOROB~1\DOCUME~1\MATLAB\CARTES~1
S_FUNCTIONS     = xpcudpbytereceive.c encconteccnt328mpci.c dopci8255.c dacbpcidda0x12.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = Registration_Estimationlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Registration_Estimation_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Registration_Estimation_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Biorobotics\Documents\MATLAB
