...
MODEL           = backup_test1
MODULES         = backup_test1_capi.c backup_test1_data.c backup_test1_tgtconn.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = backup_test1.mk
...
MODELLIB                  = backup_test1lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = backup_test1_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\backup_test1_slrt_rtw
