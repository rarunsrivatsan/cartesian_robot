...
RT_MODEL_CenterLimit_T *CenterLimit(void)
{
  ...
  /* Initialize timing info */
  {
    ...
    /* task periods */
    CenterLimit_M->Timing.sampleTimes[0] = (0.01);
  ...
  CenterLimit_M->Timing.stepSize0 = 0.01;
  ...
  CenterLimit_M->solverInfoPtr = (&CenterLimit_M->solverInfo);
  CenterLimit_M->Timing.stepSize = (0.01);
  rtsiSetFixedStepSize(&CenterLimit_M->solverInfo, 0.01);
