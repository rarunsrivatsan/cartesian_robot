...
MODEL           = test2
MODULES         = rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c test2_capi.c test2_data.c test2_tgtconn.c xpc_datatype_ground.c 
MAKEFILE        = test2.mk
...
S_FUNCTIONS     = encconteccnt328mpci.c dipci8255.c dopci8255.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = test2lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = test2_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\test2_slrt_rtw
