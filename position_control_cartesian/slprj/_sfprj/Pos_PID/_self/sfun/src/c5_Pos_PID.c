...
static void c5_enter_atomic_stopped_state(SFc5_Pos_PIDInstanceStruct
  *chartInstance);
...
static void sf_gateway_c5_Pos_PID(SFc5_Pos_PIDInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_error, 1U, 1U, 0U,
  ...
  *chartInstance->c5_sfEvent = CALL_EVENT;
  ...
  if (*chartInstance->c5_is_active_c5_Pos_PID == 0U) {
    ...
    *chartInstance->c5_is_c5_Pos_PID = c5_IN_stopped_state;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c5_sfEvent);
    c5_enter_atomic_stopped_state(chartInstance);
  } else {
    switch (*chartInstance->c5_is_c5_Pos_PID) {
     ...
     case c5_IN_stopped_state:
      ...
      guard1 = false;
      if (CV_EML_COND(1, 0, 0, (real_T)c5_y > 0.0)) {
        guard1 = true;
      } else {
        ...
        if (CV_EML_COND(1, 0, 1, *chartInstance->c5_flag == 1.0)) {
          guard1 = true;
        } else {
      ...
      if (c5_b_out) {
        ...
        *chartInstance->c5_stopped = 0.0;
        ...
        _SFD_DATA_RANGE_CHECK(*chartInstance->c5_stopped, 2U, 4U, 0U,
                              *chartInstance->c5_sfEvent, false);
        *chartInstance->c5_moving = 1.0;
        chartInstance->c5_dataWrittenToVector[1U] = true;
        _SFD_DATA_RANGE_CHECK(*chartInstance->c5_moving, 3U, 4U, 0U,
                              *chartInstance->c5_sfEvent, false);
        *chartInstance->c5_flag = 0.0;
        chartInstance->c5_dataWrittenToVector[2U] = true;
        _SFD_DATA_RANGE_CHECK(*chartInstance->c5_flag, 4U, 4U, 0U,
                              *chartInstance->c5_sfEvent, false);
        _SFD_SYMBOL_SCOPE_POP();
      } else {
  ...
  *chartInstance)
{
  ...
  *chartInstance->c5_stopped = 1.0;
  chartInstance->c5_dataWrittenToVector[0U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_stopped, 2U, 4U, 1U,
                        *chartInstance->c5_sfEvent, false);
  *chartInstance->c5_moving = 0.0;
  chartInstance->c5_dataWrittenToVector[1U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_moving, 3U, 4U, 1U,
                        *chartInstance->c5_sfEvent, false);
  *chartInstance->c5_flag = 0.0;
  chartInstance->c5_dataWrittenToVector[2U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_flag, 4U, 4U, 1U,
                        *chartInstance->c5_sfEvent, false);
  if (CV_EML_IF(1, 1, 0, CV_RELATIONAL_EVAL(4U, 1U, 0, *chartInstance->c5_error,
        0.0, -1, 0U, *chartInstance->c5_error == 0.0))) {
...
static void init_simulink_io_address(SFc5_Pos_PIDInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_flag = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 3);
  chartInstance->c5_error = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2434547468U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(133397779U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2080354258U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1043696474U);
}
...
mxArray *sf_c5_Pos_PID_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("ACEnu0i41exYjhOQMIr9nD");
...
static const mxArray *sf_get_sim_state_info_c5_Pos_PID(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[32],T\"flag\",},{M[1],M[9],T\"moving\",},{M[1],M[8],T\"stopped\",},{M[8],M[0],T\"is_active_c5_Pos_PID\",},{M[9],M[0],T\"is_c5_Pos_PID\",},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(2,2,0,1,"stopped");
          _SFD_SET_DATA_PROPS(3,2,0,1,"moving");
          _SFD_SET_DATA_PROPS(4,2,0,1,"flag");
        ...
        _SFD_CV_INIT_EML_IF(1,1,0,53,64,-1,82);
        _SFD_CV_INIT_EML_RELATIONAL(1,1,0,56,64,-1,0);
...

        {
          ...
          static int condEnd[] = { 19, 30 };

          static int pfixExpr[] = { 0, 1, -2 };

          _SFD_CV_INIT_EML_MCDC(1,0,0,1,30,2,0,&(condStart[0]),&(condEnd[0]),3,
                                &(pfixExpr[0]));
        }
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      /* do this only if simulation is starting and after we know the addresses of all data */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c5_stopped);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c5_moving);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c5_flag);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c5_error);
      }
    }
  }
}
...
static void mdlSetWorkWidths_c5_Pos_PID(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2225630221U));
  ssSetChecksum1(S,(2879798589U));
  ssSetChecksum2(S,(2966784822U));
  ssSetChecksum3(S,(2382771547U));
