 ...
 * C source code generated on : Mon Nov 21 00:13:51 2016
 *
...
void slrttestmdl_derivatives(void)
{
  ...
  _rtXdot = ((XDot_slrttestmdl_T *) slrttestmdl_M->ModelData.derivs);
...
RT_MODEL_slrttestmdl_T *slrttestmdl(void)
{
...

  {
    ...
    rtsiSetdXPtr(&slrttestmdl_M->solverInfo, &slrttestmdl_M->ModelData.derivs);
    rtsiSetContStatesPtr(&slrttestmdl_M->solverInfo, (real_T **)
                         &slrttestmdl_M->ModelData.contStates);
    ...
    rtsiSetPeriodicContStateIndicesPtr(&slrttestmdl_M->solverInfo,
      &slrttestmdl_M->ModelData.periodicContStateIndices);
    rtsiSetPeriodicContStateRangesPtr(&slrttestmdl_M->solverInfo,
      &slrttestmdl_M->ModelData.periodicContStateRanges);
  ...
  slrttestmdl_M->ModelData.intgData.y = slrttestmdl_M->ModelData.odeY;
  slrttestmdl_M->ModelData.intgData.f[0] = slrttestmdl_M->ModelData.odeF[0];
  slrttestmdl_M->ModelData.intgData.f[1] = slrttestmdl_M->ModelData.odeF[1];
  slrttestmdl_M->ModelData.intgData.f[2] = slrttestmdl_M->ModelData.odeF[2];
  slrttestmdl_M->ModelData.intgData.f[3] = slrttestmdl_M->ModelData.odeF[3];
  slrttestmdl_M->ModelData.contStates = ((real_T *) &slrttestmdl_X);
  rtsiSetSolverData(&slrttestmdl_M->solverInfo, (void *)
                    &slrttestmdl_M->ModelData.intgData);
  ...
  /* block I/O */
  slrttestmdl_M->ModelData.blockIO = ((void *) &slrttestmdl_B);
  ...
  /* parameters */
  slrttestmdl_M->ModelData.defaultParam = ((real_T *)&slrttestmdl_P);

  /* states (continuous) */
  {
    real_T *x = (real_T *) &slrttestmdl_X;
    slrttestmdl_M->ModelData.contStates = (x);
    (void) memset((void *)&slrttestmdl_X, 0,
                  sizeof(X_slrttestmdl_T));
  }

  /* states (dwork) */
  slrttestmdl_M->ModelData.dwork = ((void *) &slrttestmdl_DW);
  (void) memset((void *)&slrttestmdl_DW, 0,
                sizeof(DW_slrttestmdl_T));

  /* external outputs */
  slrttestmdl_M->ModelData.outputs = (&slrttestmdl_Y);
