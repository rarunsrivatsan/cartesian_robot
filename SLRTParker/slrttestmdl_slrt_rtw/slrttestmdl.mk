...
MODEL           = slrttestmdl
MODULES         = rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_nonfinite.c rtw_modelmap_utils.c slrttestmdl_capi.c slrttestmdl_data.c slrttestmdl_tgtconn.c xpc_datatype_ground.c 
