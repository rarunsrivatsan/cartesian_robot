...
MODEL           = slrt_parker
MODULES         = rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c slrt_parker_capi.c slrt_parker_data.c slrt_parker_tgtconn.c xpc_datatype_ground.c 
MAKEFILE        = slrt_parker.mk
...
S_FUNCTIONS     = encconteccnt328mpci.c xpcudpbytereceive.c dipci8255.c dacbpcidda0x12.c dopci8255.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = slrt_parkerlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = slrt_parker_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slrt_parker_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\BIOROB~1\Desktop\CARTES~1\xpc\VANDER~1\CARTES~1\Model
