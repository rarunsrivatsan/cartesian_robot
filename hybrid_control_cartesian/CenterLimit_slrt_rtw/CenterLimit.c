...
static void CenterLimit_output(void)
{
  ...
  /* ToAsyncQueueBlock: '<Root>/HiddenToAsyncQueue_InsertedFor_PCI-DDA08 12 2_at_outport_0' */
  {
    {
      double time = CenterLimit_M->Timing.t[0];
      void *pData = (void *)&CenterLimit_B.PCIDDA08122;
      int32_T size = 1*sizeof(real_T);
      sendToAsyncQueueTgtAppSvc(4240146556U, time, pData, size);
    }
  }
  ...
  /* Level2 S-Function Block: '<Root>/x axis left switch' (dipci8255) */
  {
    SimStruct *rts = CenterLimit_M->childSfunctions[3];
    sfcnOutputs(rts, 0);
  }

  /* ToAsyncQueueBlock: '<Root>/HiddenToAsyncQueue_InsertedFor_x axis left switch_at_outport_0' */
  {
    {
      double time = CenterLimit_M->Timing.t[0];
      void *pData = (void *)&CenterLimit_B.xaxisleftswitch;
      int32_T size = 1*sizeof(real_T);
      sendToAsyncQueueTgtAppSvc(525733403U, time, pData, size);
    }
  }
...
RT_MODEL_CenterLimit_T *CenterLimit(void)
{
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: CenterLimit/<Root>/x axis left switch (dipci8255) */
    {
      SimStruct *rts = CenterLimit_M->childSfunctions[3];
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          ssSetOutputPortSignal(rts, 0, ((real_T *)
            &CenterLimit_B.xaxisleftswitch));
        }
      }

      /* path info */
      ssSetModelName(rts, "x axis left switch");
      ssSetPath(rts, "CenterLimit/x axis left switch");
      ssSetRTModel(rts,CenterLimit_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParamsCount(rts, 8);
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)CenterLimit_P.xaxisleftswitch_P1_Size);
        ssSetSFcnParam(rts, 1, (mxArray*)CenterLimit_P.xaxisleftswitch_P2_Size);
        ssSetSFcnParam(rts, 2, (mxArray*)CenterLimit_P.xaxisleftswitch_P3_Size);
        ssSetSFcnParam(rts, 3, (mxArray*)CenterLimit_P.xaxisleftswitch_P4_Size);
        ssSetSFcnParam(rts, 4, (mxArray*)CenterLimit_P.xaxisleftswitch_P5_Size);
        ssSetSFcnParam(rts, 5, (mxArray*)CenterLimit_P.xaxisleftswitch_P6_Size);
        ssSetSFcnParam(rts, 6, (mxArray*)CenterLimit_P.xaxisleftswitch_P7_Size);
        ssSetSFcnParam(rts, 7, (mxArray*)CenterLimit_P.xaxisleftswitch_P8_Size);
      }

      /* work vectors */
      ssSetIWork(rts, (int_T *) &CenterLimit_DW.xaxisleftswitch_IWORK[0]);

      {
        ...
        ssSetDWorkDataType(rts, 0,SS_INTEGER);
        ssSetDWorkComplexSignal(rts, 0, 0);
        ssSetDWork(rts, 0, &CenterLimit_DW.xaxisleftswitch_IWORK[0]);
      }
    ...
    /* Level2 S-Function Block: CenterLimit/<Root>/PCI-DDA 08 12 4 (dopci8255) */
    {
      ...
      /* inputs */
      {
        ...
        /* port 0 */
        {
          ...
          sfcnUPtrs[0] = &CenterLimit_B.xaxisleftswitch;
          ssSetInputPortSignalPtrs(rts, 0, (InputPtrsType)&sfcnUPtrs[0]);
          _ssSetInputPortNumDimensions(rts, 0, 1);
          ssSetInputPortWidth(rts, 0, 1);
        }
    ...
    /* Level2 S-Function Block: CenterLimit/<Root>/PCI-DDA08 12 3 (dipci8255) */
    {
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParamsCount(rts, 8);
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)CenterLimit_P.PCIDDA08123_P1_Size_l);
        ssSetSFcnParam(rts, 1, (mxArray*)CenterLimit_P.PCIDDA08123_P2_Size_c);
        ssSetSFcnParam(rts, 2, (mxArray*)CenterLimit_P.PCIDDA08123_P3_Size_d);
        ssSetSFcnParam(rts, 3, (mxArray*)CenterLimit_P.PCIDDA08123_P4_Size_n);
        ssSetSFcnParam(rts, 4, (mxArray*)CenterLimit_P.PCIDDA08123_P5_Size_b);
        ssSetSFcnParam(rts, 5, (mxArray*)CenterLimit_P.PCIDDA08123_P6_Size_c);
        ssSetSFcnParam(rts, 6, (mxArray*)CenterLimit_P.PCIDDA08123_P7_Size_m);
        ssSetSFcnParam(rts, 7, (mxArray*)CenterLimit_P.PCIDDA08123_P8_Size_f);
      }

      /* work vectors */
      ssSetIWork(rts, (int_T *) &CenterLimit_DW.PCIDDA08123_IWORK_d[0]);

      {
        ...
        ssSetDWorkDataType(rts, 0,SS_INTEGER);
        ssSetDWorkComplexSignal(rts, 0, 0);
        ssSetDWork(rts, 0, &CenterLimit_DW.PCIDDA08123_IWORK_d[0]);
      }
