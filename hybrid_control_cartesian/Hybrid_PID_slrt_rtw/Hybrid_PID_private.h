...
#ifndef RTW_HEADER_Hybrid_PID_private_h_
#define RTW_HEADER_Hybrid_PID_private_h_
#include "rtwtypes.h"
...
extern void Hybrid_PID_Deadbandpulsecounter(real_T rtu_e, real_T rtu_db,
  B_Deadbandpulsecounter_Hybrid_T *localB);

/* private model entry point functions */
extern void Hybrid_PID_derivatives(void);

#endif                                 /* RTW_HEADER_Hybrid_PID_private_h_ */
