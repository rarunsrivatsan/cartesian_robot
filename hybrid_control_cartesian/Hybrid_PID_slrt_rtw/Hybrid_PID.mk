...
MODEL           = Hybrid_PID
MODULES         = Hybrid_PID_capi.c Hybrid_PID_data.c Hybrid_PID_tgtconn.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = Hybrid_PID.mk
...
S_FUNCTIONS     = encconteccnt328mpci.c xpcudpbytereceive.c dacbpcidda0x12.c dopci8255.c dipci8255.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 1
NCSTATES        = 6
...
MODELLIB                  = Hybrid_PIDlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Hybrid_PID_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Hybrid_PID_slrt_rtw
