...
typedef struct {
  ...
  uint16_T XMatrixCounter_Count;       /* '<S8>/X Matrix Counter' */
  uint16_T YMatrixCounter_Count;       /* '<S11>/Y Matrix Counter' */
  uint16_T ZMatrixCounter_Count;       /* '<S15>/Z Matrix Counter' */
...
struct P_Pos_PID_T_ {
  ...
  real_T kpz;                          /* Variable: kpz
                                        ...
                                        */
  real_T xpos[30000];                  /* Variable: xpos
                                        * Referenced by: '<S8>/X Matrix output'
                                        */
  real_T ypos[30000];                  /* Variable: ypos
                                        * Referenced by: '<S11>/Y Matrix output'
                                        */
  real_T zpos[30000];                  /* Variable: zpos
  ...
  real_T PIDController2_N;             /* Mask Parameter: PIDController2_N
                                        ...
                                        */
  uint16_T XMatrixCounter_InitialCount;/* Mask Parameter: XMatrixCounter_InitialCount
                                        * Referenced by: '<S8>/X Matrix Counter'
                                        */
  uint16_T YMatrixCounter_InitialCount;/* Mask Parameter: YMatrixCounter_InitialCount
                                        * Referenced by: '<S11>/Y Matrix Counter'
                                        */
  uint16_T ZMatrixCounter_InitialCount;/* Mask Parameter: ZMatrixCounter_InitialCount
