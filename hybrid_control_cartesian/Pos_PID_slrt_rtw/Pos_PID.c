...
{
  /* MATLAB Function 'Deadband pulse counter': '<S1>:1' */
...
uint32_T MWDSP_EPH_R_D(real_T evt, uint32_T *sta)
{
  ...
  /* S-Function (sdspcount2): '<S8>/X Matrix Counter' */
  ...
  /* End of S-Function (sdspcount2): '<S8>/X Matrix Counter' */
  return retVal;
}
...
void Pos_PID_output(void)
{
  ...
  if (rtmIsMajorTimeStep(Pos_PID_M)) {
    ...
    if (MWDSP_EPH_R_D(Pos_PID_B.DataTypeConversion3,
      ...
      if (Pos_PID_DW.XMatrixCounter_Count < ((uint16_T)30000U)) {
    ...
    /* Lookup_n-D: '<S8>/X Matrix output' */
    bpIdx = plook_u32d_evencka(Pos_PID_B.XMatrixindex,
      Pos_PID_P.XMatrixoutput_bpFirstPoint01Dat, 1.0, 29999U);
    Pos_PID_B.XMatrixoutput = Pos_PID_P.xpos[bpIdx];

    /* Sum: '<Root>/Sum' */
    Pos_PID_B.Sum = Pos_PID_B.XMatrixoutput - Pos_PID_B.XData;

    /* MATLAB Function: '<Root>/Deadband pulse counter' incorporates:
     *  Constant: '<Root>/Constant3'
     */
    Pos_PID_Deadbandpulsecounter(Pos_PID_B.Sum, Pos_PID_P.db_x,
  ...
  if (rtmIsMajorTimeStep(Pos_PID_M)) {
    ...
    if (MWDSP_EPH_R_D(Pos_PID_B.DataTypeConversion2,
      ...
      if (Pos_PID_DW.YMatrixCounter_Count < ((uint16_T)30000U)) {
    ...
    bpIdx = plook_u32d_evencka(Pos_PID_B.YMatrixindex,
      Pos_PID_P.YMatrixoutput_bpFirstPoint01Dat, 1.0, 29999U);
     ...
     */
    Pos_PID_Deadbandpulsecounter(Pos_PID_B.Sum2_n, Pos_PID_P.db_y,
  ...
  if (rtmIsMajorTimeStep(Pos_PID_M)) {
    ...
    if (MWDSP_EPH_R_D(Pos_PID_B.DataTypeConversion1,
      ...
      if (Pos_PID_DW.ZMatrixCounter_Count < ((uint16_T)30000U)) {
    ...
    bpIdx = plook_u32d_evencka(Pos_PID_B.ZMatrixindex,
      Pos_PID_P.ZMatrixoutput_bpFirstPoint01Dat, 1.0, 29999U);
     ...
     */
    Pos_PID_Deadbandpulsecounter(Pos_PID_B.Sum4, Pos_PID_P.db_z,
      &Pos_PID_B.sf_Deadbandpulsecounter_e);

    /* Logic: '<S6>/Logical Operator' */
    Pos_PID_B.LogicalOperator = ((Pos_PID_B.sf_Deadbandpulsecounter.pulse != 0.0)
      && (Pos_PID_B.sf_Deadbandpulsecounter_h.pulse != 0.0) &&
      (Pos_PID_B.sf_Deadbandpulsecounter_e.pulse != 0.0));

    /* UnitDelay: '<S6>/Unit Delay' */
    Pos_PID_B.UnitDelay = Pos_PID_DW.UnitDelay_DSTATE;

    /* S-Function (sdspcount2): '<S6>/Counter' */
    Pos_PID_B.Counter = false;
    ...
    if (MWDSP_EPH_R_B(Pos_PID_B.LogicalOperator, &Pos_PID_DW.Counter_ClkEphState)
        != 0U) {
      if (Pos_PID_DW.Counter_Count < ((uint8_T)1U)) {
    ...
    if (Pos_PID_DW.Counter_Count == Pos_PID_P.Counter_HitValue) {
      Pos_PID_B.Counter = true;
    }

    /* End of S-Function (sdspcount2): '<S6>/Counter' */

    /* DataStoreWrite: '<Root>/Data Store Write3' */
    Pos_PID_DW.RFlag = Pos_PID_B.Counter;
    ...
    if (rtmIsMajorTimeStep(Pos_PID_M)) {
      {
        ...
        sendToAsyncQueueTgtAppSvc(1248236544U, time, pData, size);
      }
    }
    ...
    if (rtmIsMajorTimeStep(Pos_PID_M)) {
      {
        ...
        int32_T size = 1*sizeof(real_T);
        sendToAsyncQueueTgtAppSvc(331124807U, time, pData, size);
      }
    }
  ...
  if (rtmIsMajorTimeStep(Pos_PID_M)) {
    ...
    Pos_PID_B.DataTypeConversion = Pos_PID_B.Counter;
  ...
  Pos_PID_B.DataTypeConversion_a = Pos_PID_B.Zenable_e0;
  if (rtmIsMajorTimeStep(Pos_PID_M)) {
    ...
    if (rtmIsMajorTimeStep(Pos_PID_M)) {
      {
        ...
        sendToAsyncQueueTgtAppSvc(2478898827U, time, pData, size);
      }
    }
  }
}
...
void Pos_PID_update(void)
{
  if (rtmIsMajorTimeStep(Pos_PID_M)) {
    ...
    Pos_PID_DW.UnitDelay_DSTATE = Pos_PID_B.Counter;
  }
...
void Pos_PID_initialize(void)
{
  ...
  /* S-Function Block: <S19>/S-Function (scblock) */
  {
    ...
    if ((i = rl32eScopeExists(2)) == 0) {
      if ((i = rl32eDefScope(2,2)) != 0) {
        ...
        rl32eAddSignal(2, rl32eGetSignalNo("X Position Input/X Matrix output"));
        rl32eAddSignal(2, rl32eGetSignalNo("X_Encoder/count_to_mm1"));
        rl32eAddSignal(2, rl32eGetSignalNo("Deadband pulse counter"));
        rl32eAddSignal(2, rl32eGetSignalNo(
          "Z Position signal/Deadband pulse counter"));
        rl32eAddSignal(2, rl32eGetSignalNo(
          "Y Position signal/Deadband pulse counter"));
        rl32eAddSignal(2, rl32eGetSignalNo("Data Type Conversion"));
        rl32eSetScope(2, 4, 25000);
        rl32eSetScope(2, 5, 0);
        rl32eSetScope(2, 6, 1);
        rl32eSetScope(2, 0, 0);
        rl32eSetScope(2, 3, rl32eGetSignalNo("X Position Input/X Matrix output"));
  ...
  /* S-Function Block: <S20>/S-Function (scblock) */
  {
    ...
    if ((i = rl32eScopeExists(5)) == 0) {
      if ((i = rl32eDefScope(5,3)) != 0) {
        ...
        rl32eAddSignal(5, rl32eGetSignalNo("X Position Input/X Matrix output"));
        rl32eAddSignal(5, rl32eGetSignalNo("X_Encoder/count_to_mm1"));
        rl32eAddSignal(5, rl32eGetSignalNo("Deadband pulse counter"));
        rl32eAddSignal(5, rl32eGetSignalNo(
          "Z Position signal/Deadband pulse counter"));
        rl32eAddSignal(5, rl32eGetSignalNo(
          "Y Position signal/Deadband pulse counter"));
        rl32eAddSignal(5, rl32eGetSignalNo("Data Type Conversion"));
        ...
        rl32eSetScope(5, 3, rl32eGetSignalNo("X Position Input/X Matrix output"));
  ...
  /* InitializeConditions for S-Function (sdspcount2): '<S8>/X Matrix Counter' */
...
RT_MODEL_Pos_PID_T *Pos_PID(void)
{
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: Pos_PID/<S17>/PCI-DDA 08 12 1 (dopci8255) */
    {
      ...
      /* inputs */
      {
        ...
        /* port 0 */
        {
          ...
          sfcnUPtrs[0] = &Pos_PID_B.DataTypeConversion_a;
          ssSetInputPortSignalPtrs(rts, 0, (InputPtrsType)&sfcnUPtrs[0]);
          _ssSetInputPortNumDimensions(rts, 0, 1);
          ssSetInputPortWidth(rts, 0, 1);
        }
    ...
    /* Level2 S-Function Block: Pos_PID/<S2>/Receive 1 (xpcudpbytereceive) */
    {
      SimStruct *rts = Pos_PID_M->childSfunctions[8];
  ...
  Pos_PID_M->Sizes.numBlocks = (105);  /* Number of blocks */
  Pos_PID_M->Sizes.numBlockIO = (76);  /* Number of block outputs */
  Pos_PID_M->Sizes.numBlockPrms = (90537);/* Sum of parameter "widths" */
  return Pos_PID_M;
}
