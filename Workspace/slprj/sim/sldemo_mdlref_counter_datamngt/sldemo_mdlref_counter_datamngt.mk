###########################################################################
## Makefile generated for Simulink model 'sldemo_mdlref_counter_datamngt'. 
## 
## Makefile     : sldemo_mdlref_counter_datamngt.mk
## Generated on : Tue Dec 27 12:19:36 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/sldemo_mdlref_counter_datamngt_msf.mexw64
...
PRODUCT_NAME              = sldemo_mdlref_counter_datamngt
MAKEFILE                  = sldemo_mdlref_counter_datamngt.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/BIOROB~1/DOCUME~1/MATLAB/POSITI~1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = sldemo_mdlref_counter_datamngt_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ../../..
MODELREF_LINK_RSPFILE     = sldemo_mdlref_counter_datamngt_ref.rsp
MEX_SRC                   = sldemo_mdlref_counter_datamngt_msf.c
...
MODELLIB                  = sldemo_mdlref_counter_datamngtlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/sldemo_mdlref_counter_datamngt_msf.mexw64
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/slprj/sim/sldemo_mdlref_counter_datamngt -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/simulink/simdemos/simfeatures/modelreference -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/sim/_sharedutils
...
DEFINES_STANDARD = -DNDEBUG -DMODEL=sldemo_mdlref_counter_datamngt -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
SRCS = $(START_DIR)/slprj/sim/sldemo_mdlref_counter_datamngt/sldemo_mdlref_counter_datamngt.c $(START_DIR)/slprj/sim/sldemo_mdlref_counter_datamngt/sldemo_mdlref_counter_datamngt_capi.c
...
OBJS = sldemo_mdlref_counter_datamngt.obj sldemo_mdlref_counter_datamngt_capi.obj
...
%.obj : $(START_DIR)/slprj/sim/sldemo_mdlref_counter_datamngt/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/sldemo_mdlref_counter_datamngt/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
