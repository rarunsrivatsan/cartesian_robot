...
MODEL           = Pos_PID
MODULES         = Pos_PID_capi.c Pos_PID_data.c Pos_PID_tgtconn.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = Pos_PID.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\Biorobotics\Documents\MATLAB\Workspace
S_FUNCTIONS     = encconteccnt328mpci.c dacbpcidda0x12.c dopci8255.c dipci8255.c xpcudpbytereceive.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 1
NCSTATES        = 6
...
MODELLIB                  = Pos_PIDlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Pos_PID_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Pos_PID_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\BIOROB~1\DOCUME~1\MATLAB\POSITI~1
