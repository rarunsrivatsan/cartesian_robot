...
typedef struct {
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_b;                 /* '<S8>/S-Function' */
...
} PrevZCX_Registration_Estimation_T;
...
#define rtPrevZCSigState               Registration_Estimation_PrevZCX
#define PrevZCSigStates                PrevZCX_Registration_Estimation_T
...
/* Zero-crossing (trigger) state */
extern PrevZCX_Registration_Estimation_T Registration_Estimation_PrevZCX;
