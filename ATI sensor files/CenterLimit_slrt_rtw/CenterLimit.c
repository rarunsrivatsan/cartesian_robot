...
static void CenterLimit_output(void)
{
  ...
  CenterLimit_DW.SFunction_IWORK.AcquireOK = 1;

  /* ok to acquire for <S3>/S-Function */
  CenterLimit_DW.SFunction_IWORK_h.AcquireOK = 1;
  ...
  (void)memcpy((uint8_T*)&CenterLimit_B.orceData[0], (uint8_T*)
               &CenterLimit_B.Receive1_o1[0] + 0, 48);
  ...
  /* S-Function Block: <S2>/S-Function (scblock) */
  {
    ...
    if ((i = rl32eScopeExists(2)) == 0) {
      if ((i = rl32eDefScope(2,2)) != 0) {
        ...
        xpceScopeAcqOK(2, &CenterLimit_DW.SFunction_IWORK.AcquireOK);
      }
    }
  ...
  /* S-Function Block: <S3>/S-Function (scblock) */
  {
    ...
    if ((i = rl32eScopeExists(1)) == 0) {
      if ((i = rl32eDefScope(1,2)) != 0) {
        ...
        rl32eAddSignal(1, rl32eGetSignalNo("Byte Unpacking 1/s1"));
        rl32eAddSignal(1, rl32eGetSignalNo("Byte Unpacking 1/s2"));
        rl32eAddSignal(1, rl32eGetSignalNo("Byte Unpacking 1/s3"));
        rl32eAddSignal(1, rl32eGetSignalNo("Byte Unpacking 1/s4"));
        rl32eAddSignal(1, rl32eGetSignalNo("Byte Unpacking 1/s5"));
        rl32eAddSignal(1, rl32eGetSignalNo("Byte Unpacking 1/s6"));
        rl32eSetScope(1, 4, 10000);
        rl32eSetScope(1, 5, 0);
        rl32eSetScope(1, 6, 1);
        rl32eSetScope(1, 0, 0);
        rl32eSetScope(1, 3, rl32eGetSignalNo("Byte Unpacking 1/s1"));
        ...
        xpceScopeAcqOK(1, &CenterLimit_DW.SFunction_IWORK_h.AcquireOK);
      }
    }
...
RT_MODEL_CenterLimit_T *CenterLimit(void)
{
  ...
  CenterLimit_M->Sizes.numSFcns = (6);
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: CenterLimit/<Root>/Receive 1 (xpcudpbytereceive) */
    {
      SimStruct *rts = CenterLimit_M->childSfunctions[0];
      ...
      /* outputs */
      {
        ssSetPortInfoForOutputs(rts,
          &CenterLimit_M->NonInlinedSFcns.Sfcn0.outputPortInfo[0]);
        ...
        /* port 0 */
        {
          ...
          ssSetOutputPortSignal(rts, 0, ((uint8_T *) CenterLimit_B.Receive1_o1));
        }
        ...
        /* port 1 */
        {
          ...
          ssSetOutputPortSignal(rts, 1, ((real_T *) &CenterLimit_B.Receive1_o2));
        }
      }

      /* path info */
      ssSetModelName(rts, "Receive 1");
      ssSetPath(rts, "CenterLimit/Receive 1");
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParam(rts, 0, (mxArray*)CenterLimit_P.Receive1_P1_Size);
        ssSetSFcnParam(rts, 1, (mxArray*)CenterLimit_P.Receive1_P2_Size);
        ssSetSFcnParam(rts, 2, (mxArray*)CenterLimit_P.Receive1_P3_Size);
        ssSetSFcnParam(rts, 3, (mxArray*)CenterLimit_P.Receive1_P4_Size);
        ssSetSFcnParam(rts, 4, (mxArray*)CenterLimit_P.Receive1_P5_Size);
      }

      /* work vectors */
      ssSetIWork(rts, (int_T *) &CenterLimit_DW.Receive1_IWORK[0]);
      ssSetPWork(rts, (void **) &CenterLimit_DW.Receive1_PWORK);

      {
        ...
        ssSetDWork(rts, 0, &CenterLimit_DW.Receive1_IWORK[0]);

        /* PWORK */
        ssSetDWorkWidth(rts, 1, 1);
        ssSetDWorkDataType(rts, 1,SS_POINTER);
        ssSetDWorkComplexSignal(rts, 1, 0);
        ssSetDWork(rts, 1, &CenterLimit_DW.Receive1_PWORK);
      }
    ...
    /* Level2 S-Function Block: CenterLimit/<Root>/PCI-DDA08 12  (dacbpcidda0x12) */
    {
      ...
      /* inputs */
      {
        ...
        ssSetPortInfoForInputs(rts,
          &CenterLimit_M->NonInlinedSFcns.Sfcn1.inputPortInfo[0]);

        /* port 0 */
        {
          real_T const **sfcnUPtrs = (real_T const **)
            &CenterLimit_M->NonInlinedSFcns.Sfcn1.UPtrs0;
        ...
        {
          real_T const **sfcnUPtrs = (real_T const **)
            &CenterLimit_M->NonInlinedSFcns.Sfcn1.UPtrs1;
          sfcnUPtrs[0] = &CenterLimit_B.Constant;
    ...
    /* Level2 S-Function Block: CenterLimit/<Root>/PCI-DDA08 12 2 (dipci8255) */
    {
      ...
      {
        ssSetPortInfoForOutputs(rts,
          &CenterLimit_M->NonInlinedSFcns.Sfcn2.outputPortInfo[0]);
    ...
    /* Level2 S-Function Block: CenterLimit/<Root>/PCI-DDA 08 12 3 (dopci8255) */
    {
      ...
      /* inputs */
      {
        ...
        ssSetPortInfoForInputs(rts,
          &CenterLimit_M->NonInlinedSFcns.Sfcn3.inputPortInfo[0]);

        /* port 0 */
        {
          real_T const **sfcnUPtrs = (real_T const **)
            &CenterLimit_M->NonInlinedSFcns.Sfcn3.UPtrs0;
    ...
    /* Level2 S-Function Block: CenterLimit/<Root>/PCI-DDA08 12 1 (dipci8255) */
    {
      ...
      {
        ssSetPortInfoForOutputs(rts,
          &CenterLimit_M->NonInlinedSFcns.Sfcn4.outputPortInfo[0]);
        _ssSetNumOutputPorts(rts, 1);
    ...
    /* Level2 S-Function Block: CenterLimit/<Root>/PCI-DDA 08 12 4 (dopci8255) */
    {
      ...
      /* inputs */
      {
        _ssSetNumInputPorts(rts, 1);
        ssSetPortInfoForInputs(rts,
          &CenterLimit_M->NonInlinedSFcns.Sfcn5.inputPortInfo[0]);

        /* port 0 */
        {
          real_T const **sfcnUPtrs = (real_T const **)
            &CenterLimit_M->NonInlinedSFcns.Sfcn5.UPtrs0;
  ...
  CenterLimit_M->Sizes.numBlocks = (10);/* Number of blocks */
  CenterLimit_M->Sizes.numBlockIO = (6);/* Number of block outputs */
  CenterLimit_M->Sizes.numBlockPrms = (167);/* Sum of parameter "widths" */
