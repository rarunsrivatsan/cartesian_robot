...
typedef struct {
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_h;                 /* '<S3>/S-Function' */
 ...
 *
 * '<Root>' : 'CenterLimit'
 * '<S1>'   : 'CenterLimit/Counter1'
 * '<S2>'   : 'CenterLimit/Scope 1'
 * '<S3>'   : 'CenterLimit/Scope 5'
 */
