...
MODEL           = rx_target
MODULES         = rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_nonfinite.c rtw_modelmap_utils.c rx_target_capi.c rx_target_tgtconn.c xpc_datatype_ground.c 
MAKEFILE        = rx_target.mk
...
MODELLIB                  = rx_targetlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = rx_target_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\rx_target_slrt_rtw
