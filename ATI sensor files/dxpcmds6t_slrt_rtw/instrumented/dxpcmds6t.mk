...
MODEL           = dxpcmds6t
MODULES         = dxpcmds6t_capi.c dxpcmds6t_data.c dxpcmds6t_tgtconn.c rt_logging.c rt_logging_mmi.c rtw_modelmap_utils.c xpc_datatype_ground.c host_timer_x86.c xpc_code_profiling_utility_functions.c 
MAKEFILE        = dxpcmds6t.mk
...
MULTITASKING    = 1
EXT_MODE        = 0
MEX_OPT_FILE    = -f "C:\Program Files\MATLAB\R2016a\bin\win64\mexopts\msvc2013.xml"

MODELREFS       = dxpcmds_ref1 dxpcmds_ref2 
SHARED_SRC      = ..\..\slprj\slrt\_sharedutils\*.c*
SHARED_SRC_DIR  = ..\..\slprj\slrt\_sharedutils
SHARED_BIN_DIR  = ..\..\slprj\slrt\_sharedutils\instrumented
SHARED_LIB      = ..\..\slprj\slrt\_sharedutils\instrumented\rtwshared.lib
VISUAL_VER      = 12.0
...
MODELLIB                  = dxpcmds6tlib.lib
MODELREF_LINK_LIBS        =  dxpcmds_ref1_rtwlib.lib dxpcmds_ref2_rtwlib.lib
MODELREF_LINK_RSPFILE     = dxpcmds6t_ref.rsp
MODELREF_INC_PATH         = referenced_model_includes;
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\dxpcmds6t_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\xpcdemos
