...
#define S_FUNCTION_NAME dxpcmds_ref2_msf
#endif
...
MdlRefChildMdlRec childModels [ 1 ] = { "dxpcmds_ref2" , "dxpcmds_ref2" , 0 }
...
slmrInitializeIOPortDataVectors ( S , 1 , 3 ) ; if ( ! ssSetNumInputPorts ( S
, 1 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 6000 ) )
...
ssSetInputPortOffsetTime ( S , 0 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 3
...
mr_dxpcmds_ref2_RegisterSimStateChecksum ( S ) ; { static ssRTWStorageType
...
mr_dxpcmds_ref2_MdlInfoRegFcn ( S , "dxpcmds_ref2" , & retVal ) ; if ( !
retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( jeaeubzy3eu ) ) )
...
jeaeubzy3eu * dw = ( jeaeubzy3eu * ) ssGetDWork ( S , 0 ) ; real_T * o_B_1_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_1_3 = ( real_T
* ) ssGetOutputPortSignal ( S , 2 ) ; const real_T * i_ixoyurlq1i = ( real_T
* ) ssGetInputPortSignal ( S , 0 ) ; real_T * o_B_1_2 = ( real_T * )
ssGetOutputPortSignal ( S , 1 ) ; if ( tid != CONSTANT_TID && tid !=
PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 , tid ) ) {
dxpcmds_ref2TID0 ( o_B_1_1 , & ( dw -> rtb ) ) ; } if ( ssIsSampleHit ( S , 1
, tid ) ) { dxpcmds_ref2TID1 ( o_B_1_3 , & ( dw -> rtb ) ) ; } if (
ssIsSampleHit ( S , 2 , tid ) ) { dxpcmds_ref2TID2 ( i_ixoyurlq1i , o_B_1_2 ,
& ( dw -> rtb ) ) ; } } } static void mdlTerminate ( SimStruct * S ) { return
; }
...
dwFieldNames ) ; { mxArray * mdlrefDW = mr_dxpcmds_ref2_GetDWork ( ssGetDWork
( S , 0 ) ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray *
data = mr_dxpcmds_ref2_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber (
...
mr_dxpcmds_ref2_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0
