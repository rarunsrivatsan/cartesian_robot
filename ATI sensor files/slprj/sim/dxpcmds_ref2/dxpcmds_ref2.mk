###########################################################################
## Makefile generated for Simulink model 'dxpcmds_ref2'. 
## 
## Makefile     : dxpcmds_ref2.mk
## Generated on : Sat Nov 19 19:12:03 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/dxpcmds_ref2_msf.mexw64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = dxpcmds_ref2_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ../../..
MODELREF_LINK_RSPFILE     = dxpcmds_ref2_ref.rsp
MEX_SRC                   = dxpcmds_ref2_msf.c
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/dxpcmds_ref2_msf.mexw64
...
INCLUDES_BUILDINFO = -I$(START_DIR)/slprj/sim/dxpcmds_ref2 -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/rtw/targets/xpc/xpcdemos -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/sim/_sharedutils
...
DEFINES_STANDARD = -DNDEBUG -DMODEL=dxpcmds_ref2 -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
SRCS = $(START_DIR)/slprj/sim/dxpcmds_ref2/dxpcmds_ref2.c $(START_DIR)/slprj/sim/dxpcmds_ref2/dxpcmds_ref2_capi.c
...
OBJS = dxpcmds_ref2.obj dxpcmds_ref2_capi.obj
...
%.obj : $(START_DIR)/slprj/sim/dxpcmds_ref2/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/dxpcmds_ref2/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
