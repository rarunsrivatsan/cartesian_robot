...
bio(1).dim=[600,1];
bio(1).sigWidth=600;
bio(1).sigAddress='&localB->Gain2[0]';
bio(1).ndims=2;
bio(1).size=[];
...
bio(2).dim=[3000,1];
bio(2).sigWidth=3000;
bio(2).sigAddress='&localB->Gain3[0]';
bio(2).ndims=2;
bio(2).size=[];
...
bio(3).dim=[6000,1];
bio(3).sigWidth=6000;
bio(3).sigAddress='&localB->Gain4[0]';
bio(3).ndims=2;
bio(3).size=[];
...
bio(8).dim=[3000,1];
bio(8).sigWidth=3000;
bio(8).sigAddress='&localB->Abs_h[0]';
bio(8).ndims=2;
bio(8).size=[];
...
bio(9).dim=[6000,1];
bio(9).sigWidth=6000;
bio(9).sigAddress='&localB->Abs_i[0]';
bio(9).ndims=2;
bio(9).size=[];
...
bio(10).dim=[600,1];
bio(10).sigWidth=600;
bio(10).sigAddress='&localB->exp_d[0]';
bio(10).ndims=2;
bio(10).size=[];
...
bio(11).dim=[600,1];
bio(11).sigWidth=600;
bio(11).sigAddress='&localB->log_c[0]';
bio(11).ndims=2;
bio(11).size=[];
...
bio(12).dim=[600,1];
bio(12).sigWidth=600;
bio(12).sigAddress='&localB->exp_a[0]';
bio(12).ndims=2;
bio(12).size=[];
...
bio(13).dim=[600,1];
bio(13).sigWidth=600;
bio(13).sigAddress='&localB->log_n[0]';
bio(13).ndims=2;
bio(13).size=[];
...
bio(14).dim=[600,1];
bio(14).sigWidth=600;
bio(14).sigAddress='&localB->exp_c[0]';
bio(14).ndims=2;
bio(14).size=[];
...
bio(15).dim=[600,1];
bio(15).sigWidth=600;
bio(15).sigAddress='&localB->log_a[0]';
bio(15).ndims=2;
bio(15).size=[];
...
bio(16).portIdx=0;
bio(16).dim=[3000,1];
bio(16).sigWidth=3000;
bio(16).sigAddress='&localB->exp_o[0]';
bio(16).ndims=2;
bio(16).size=[];
...
bio(17).portIdx=0;
bio(17).dim=[3000,1];
bio(17).sigWidth=3000;
bio(17).sigAddress='&localB->log_o[0]';
bio(17).ndims=2;
bio(17).size=[];
...
bio(18).portIdx=0;
bio(18).dim=[3000,1];
bio(18).sigWidth=3000;
bio(18).sigAddress='&localB->exp_n[0]';
bio(18).ndims=2;
bio(18).size=[];
...
bio(19).portIdx=0;
bio(19).dim=[3000,1];
bio(19).sigWidth=3000;
bio(19).sigAddress='&localB->log_l[0]';
bio(19).ndims=2;
bio(19).size=[];
...
bio(20).portIdx=0;
bio(20).dim=[3000,1];
bio(20).sigWidth=3000;
bio(20).sigAddress='&localB->exp_cn[0]';
bio(20).ndims=2;
bio(20).size=[];
...
bio(21).portIdx=0;
bio(21).dim=[3000,1];
bio(21).sigWidth=3000;
bio(21).sigAddress='&localB->log_p[0]';
bio(21).ndims=2;
bio(21).size=[];
...
bio(22).portIdx=0;
bio(22).dim=[6000,1];
bio(22).sigWidth=6000;
bio(22).sigAddress='&localB->exp_al[0]';
bio(22).ndims=2;
bio(22).size=[];
...
bio(23).portIdx=0;
bio(23).dim=[6000,1];
bio(23).sigWidth=6000;
bio(23).sigAddress='&localB->log_cp[0]';
bio(23).ndims=2;
bio(23).size=[];
...
bio(24).portIdx=0;
bio(24).dim=[6000,1];
bio(24).sigWidth=6000;
bio(24).sigAddress='&localB->exp_at[0]';
bio(24).ndims=2;
bio(24).size=[];
...
bio(25).portIdx=0;
bio(25).dim=[6000,1];
bio(25).sigWidth=6000;
bio(25).sigAddress='&localB->log_l3[0]';
bio(25).ndims=2;
bio(25).size=[];
...
bio(26).portIdx=0;
bio(26).dim=[6000,1];
bio(26).sigWidth=6000;
bio(26).sigAddress='&localB->exp_e[0]';
bio(26).ndims=2;
bio(26).size=[];
...
bio(27).portIdx=0;
bio(27).dim=[6000,1];
bio(27).sigWidth=6000;
bio(27).sigAddress='&localB->log_i[0]';
bio(27).ndims=2;
bio(27).size=[];
