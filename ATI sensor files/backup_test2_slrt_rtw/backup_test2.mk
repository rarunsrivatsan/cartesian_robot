...
MODEL           = backup_test2
MODULES         = backup_test2_capi.c backup_test2_data.c backup_test2_tgtconn.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = backup_test2.mk
...
S_FUNCTIONS     = encconteccnt328mpci.c dopci8255.c dacbpcidda0x12.c xpcudpbytereceive.c dipci8255.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = backup_test2lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = backup_test2_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\backup_test2_slrt_rtw
