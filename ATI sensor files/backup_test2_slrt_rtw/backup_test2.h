...
#ifndef RTW_HEADER_backup_test2_h_
#define RTW_HEADER_backup_test2_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#include "rtw_modelmap.h"
#ifndef backup_test2_COMMON_INCLUDES_
# define backup_test2_COMMON_INCLUDES_
...
#include "xpcimports.h"
#endif                                 /* backup_test2_COMMON_INCLUDES_ */

#include "backup_test2_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_backup_test2           RT_MODEL_backup_test2_T

/* Definition for use in the target main file */
#define backup_test2_rtModel           RT_MODEL_backup_test2_T
...
typedef struct {
  real_T counts;                       /* '<Root>/CNT32-8M(PCI) 2' */
  real_T Sum3;                         /* '<Root>/Sum3' */
  real_T CurrentX;                     /* '<Root>/count_to_mm1' */
  real_T counts_o;                     /* '<Root>/CNT32-8M(PCI) 1' */
  real_T Sum2;                         /* '<Root>/Sum2' */
  real_T CurrentY;                     /* '<Root>/count_to_mm' */
  ...
  real_T ForceData[6];                 /* '<Root>/Byte Unpacking 1' */
...
typedef struct {
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_j;                 /* '<S3>/S-Function' */

  struct {
    int_T AcquireOK;
  } SFunction_IWORK_n;                 /* '<S4>/S-Function' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_d;                 /* '<S7>/S-Function' */

  int_T PCIDDA08121_IWORK[2];          /* '<Root>/PCI-DDA08 12 1' */
} DW_backup_test2_T;

/* Backward compatible GRT Identifiers */
#define rtB                            backup_test2_B
#define BlockIO                        B_backup_test2_T
#define rtP                            backup_test2_P
#define Parameters                     P_backup_test2_T
#define rtDWork                        backup_test2_DW
#define D_Work                         DW_backup_test2_T

/* Parameters (auto storage) */
struct P_backup_test2_T_ {
  ...
  real_T count_to_mm_Gain;             /* Expression: 200/82720
                                        ...
                                        */
  real_T Voltage1_Gain;                /* Expression: 2.1
                                        * Referenced by: '<Root>/Voltage1'
                                        */
  real_T Voltage_Gain;                 /* Expression: 2.3
...
extern P_backup_test2_T backup_test2_P;

/* Block signals (auto storage) */
extern B_backup_test2_T backup_test2_B;

/* Block states (auto storage) */
extern DW_backup_test2_T backup_test2_DW;

/*====================*
 * External functions *
 *====================*/
extern backup_test2_rtModel *backup_test2(void);
...
extern const rtwCAPI_ModelMappingStaticInfo*
  backup_test2_GetCAPIStaticMap(void);

/* Real-time Model object */
extern RT_MODEL_backup_test2_T *const backup_test2_M;
 ...
 *
 * '<Root>' : 'backup_test2'
 * '<S1>'   : 'backup_test2/Counter1'
 * '<S2>'   : 'backup_test2/Counter2'
 * '<S3>'   : 'backup_test2/Counter4'
 * '<S4>'   : 'backup_test2/Current X'
 * '<S5>'   : 'backup_test2/Current X1'
 * '<S6>'   : 'backup_test2/MATLAB Function'
 * '<S7>'   : 'backup_test2/Scope 2'
 */
#endif                                 /* RTW_HEADER_backup_test2_h_ */
